export const driverConductordata = {
  '1': {
    '1': {
      luckyNumbers: [1, 6],
      luckyColors: ['Yellow'],
    ...
    '8': {
      luckyNumbers: [1, 5, 6],
      luckyColors: ['Yellow', 'Blue'],
      luckyNameNumbers: [14, 15, 19, 23, 24, 32, 33, 37, 41, 42, 46, 59, 64],
    ...
    '9': {
      ...
      luckyNameNumbers: [
        6, 9, 14, 15, 19, 23, 24, 27, 32, 33, 37, 41, 42, 46, 51, 60, 64, 69,
        78, 87, 96,
      ],
      luckyBusinessNumbers: [
        9, 14, 15, 18, 19, 23, 24, 27, 32, 33, 36, 37, 41, 42, 45, 46, 51, 54,
  ...
  '3': {
    '1': {
      luckyNumbers: [1, 3],
      luckyColors: ['Rose', 'Orange', 'Violet', 'Blue'],
    ...
    '2': {
      luckyNumbers: [3, 5, 7],
      luckyColors: ['Rose', 'Orange', 'Violet'],
    ...
    '3': {
      ...
      luckyColors: ['Rose', 'Orange', 'Violet'],
      luckyNameNumbers: [
        14, 19, 21, 23, 27, 36, 37, 39, 41, 45, 46, 50, 59, 64, 73,
      ],
    ...
    '4': {
      luckyNumbers: [1, 3],
      luckyColors: ['Rose', 'Orange', 'Violet', 'Yellow'],
    ...
    '9': {
      luckyNumbers: [1, 3, 5, 9],
      luckyColors: ['Rose', 'Orange', 'Violet', 'Yellow', 'Blue'],
      luckyNameNumbers: [
        9, 14, 18, 19, 21, 23, 27, 32, 37, 39, 41, 46, 50, 59, 64, 77,
      ],
      luckyBusinessNumbers: [
  ...
  '4': {
    '1': {
      luckyNumbers: [1, 6],
      luckyColors: ['Yellow', 'Blue'],
      luckyNameNumbers: [15, 19, 24, 33, 37, 42, 46, 51, 60, 64, 69, 73, 91],
      luckyBusinessNumbers: [
    ...
    '3': {
      luckyNumbers: [1, 3],
      luckyColors: ['Yellow', 'Blue', 'Violet', 'Rose'],
    ...
    '4': {
      luckyNumbers: [1, 6],
      luckyColors: ['Yellow', 'Blue'],
      luckyNameNumbers: [10, 15, 19, 24, 33, 37, 42, 46, 51, 60, 64, 69, 73],
      luckyBusinessNumbers: [
    ...
    '5': {
      ...
      luckyNameNumbers: [
        10, 14, 15, 19, 23, 24, 32, 33, 37, 41, 42, 46, 50, 51, 59, 60, 64, 69,
        73,
      ],
      luckyBusinessNumbers: [
        10, 14, 15, 19, 23, 24, 32, 33, 37, 41, 42, 46, 50, 51, 59, 60, 64, 69,
  ...
  '5': {
    ...
    '2': {
      ...
      luckyBusinessNumbers: [14, 23, 32, 41, 59, 77],
    },
    '3': {
      description:
      ...
      luckyBusinessNumbers: [5, 14, 21, 23, 32, 39, 41, 59, 77],
    },
    '4': {
      description:
      ...
      luckyColors: ['Yellow', 'Blue', 'Grey'],
      luckyNameNumbers: [
        5, 14, 15, 19, 23, 24, 32, 33, 37, 41, 42, 46, 50, 51, 59, 60, 69, 71,
      ],
      luckyBusinessNumbers: [
        5, 14, 15, 19, 23, 24, 32, 33, 37, 41, 42, 46, 50, 51, 59, 60, 69, 71,
      ],
    ...
    '5': {
      ...
      luckyColors: ['Yellow', 'Blue', 'Green'],
      luckyNameNumbers: [
        5, 14, 23, 27, 32, 36, 41, 45, 50, 54, 59, 63, 72, 77, 90,
      ],
      luckyBusinessNumbers: [
        5, 14, 23, 27, 32, 36, 41, 45, 50, 54, 59, 63, 72, 77, 90,
      ],
    ...
    '6': {
      ...
      luckyNameNumbers: [
        5, 6, 14, 15, 23, 24, 32, 33, 41, 42, 50, 51, 59, 60, 69, 77,
      ],
      luckyBusinessNumbers: [
        5, 6, 14, 15, 23, 24, 32, 33, 41, 42, 50, 51, 59, 60, 69, 77,
      ],
    ...
    '9': {
      ...
      luckyBusinessNumbers: [
        5, 9, 14, 18, 23, 27, 32, 36, 41, 45, 50, 54, 59, 77,
      ],
    },
  },
  '6': {
    ...
    '2': {
      ...
      luckyBusinessNumbers: [6, 15, 24, 33, 42, 51, 60, 69],
    },
    '3': {
      description:
      ...
      luckyBusinessNumbers: [19, 27, 36, 37, 45, 46, 54, 55, 64],
    },
    '4': {
      description:
    ...
    '8': {
      ...
      luckyColors: ['Green', 'Blue', 'Yellow'],
      luckyNameNumbers: [
        14, 15, 19, 23, 24, 32, 33, 37, 41, 42, 46, 50, 51, 55, 59, 60, 64, 69,
      ],
      luckyBusinessNumbers: [
        14, 15, 19, 23, 24, 32, 33, 37, 41, 42, 46, 50, 51, 55, 59, 60, 64, 69,
      ],
    ...
    '9': {
      ...
      luckyBusinessNumbers: [15, 24, 27, 33, 37, 42, 45, 51, 54, 60, 69],
    },
  },
  '7': {
    '1': {
    ...
    '2': {
      ...
      luckyBusinessNumbers: [6, 15, 19, 24, 33, 38, 42, 51, 60, 65, 69],
    },
    '3': {
      description:
      ...
      luckyBusinessNumbers: [5, 14, 21, 23, 32, 39, 41, 50, 59],
    },
    '4': {
      description:
      ...
      luckyBusinessNumbers: [6, 15, 24, 33, 42, 61, 60, 69],
    },
    '5': {
      description:
      ...
      luckyNameNumbers: [
        14, 15, 23, 24, 32, 33, 41, 42, 50, 51, 59, 60, 69, 77,
      ],
      luckyBusinessNumbers: [
        14, 15, 23, 24, 32, 33, 41, 42, 50, 51, 59, 60, 69, 77,
      ],
    ...
    '7': {
      ...
      luckyBusinessNumbers: [
        14, 15, 23, 32, 33, 41, 42, 50, 51, 59, 60, 69, 77,
      ],
    },
    '8': {
      description:
  ...
  '8': {
    '1': {
      ...
      luckyBusinessNumbers: [14, 23, 32, 41, 50, 59, 77],
    },
    '2': {
      description:
    ...
    '3': {
      ...
      luckyNameNumbers: [
        10, 14, 19, 23, 32, 37, 41, 46, 50, 59, 64, 73, 77, 82, 86, 91,
      ],
      luckyBusinessNumbers: [
        10, 14, 19, 23, 32, 37, 41, 46, 50, 59, 64, 73, 77, 82, 86, 91,
      ],
    ...
    '6': {
      ...
      luckyColors: ['Grey', 'Yellow', 'Blue'],
      luckyNameNumbers: [
        10, 14, 15, 19, 23, 24, 32, 33, 37, 41, 42, 46, 50, 51, 55, 59, 60, 64,
        69, 73, 77, 78, 82, 86,
      ],
      luckyBusinessNumbers: [
        10, 14, 15, 19, 23, 24, 32, 33, 37, 41, 42, 46, 50, 51, 55, 59, 60, 64,
    ...
    '7': {
      ...
      luckyBusinessNumbers: [
        14, 15, 23, 24, 32, 33, 41, 42, 50, 51, 59, 60, 77,
      ],
    },
    '8': {
      description:
      ...
      luckyColors: ['Yellow', 'Blue'],
      luckyNameNumbers: [
        14, 23, 24, 32, 33, 41, 42, 50, 51, 59, 60, 69, 77, 78,
      ],
      luckyBusinessNumbers: [
        14, 23, 24, 32, 33, 41, 42, 50, 51, 59, 60, 69, 77, 78,
      ],
  ...
  '9': {
    '1': {
      ...
      luckyColors: ['Yellow', 'Blue', 'Red'],
      luckyNameNumbers: [
        5, 14, 15, 23, 24, 27, 32, 33, 37, 41, 42, 45, 46, 50, 51, 59, 60, 64,
        69, 77,
      ],
      luckyBusinessNumbers: [
        5, 14, 15, 23, 24, 27, 32, 33, 37, 41, 42, 45, 46, 50, 51, 59, 60, 64,
    ...
    '2': {
      ...
      luckyColors: ['Yellow', 'Blue'],
      luckyNameNumbers: [
        5, 14, 15, 23, 24, 32, 33, 41, 42, 50, 51, 59, 60, 69, 77,
      ],
      luckyBusinessNumbers: [
        5, 14, 15, 23, 24, 32, 33, 41, 42, 50, 51, 59, 60, 69, 77,
      ],
    ...
    '4': {
      ...
      luckyColors: ['Yellow', 'Blue', 'Red'],
      luckyNameNumbers: [
        5, 14, 15, 18, 23, 24, 27, 32, 33, 36, 37, 41, 42, 45, 46, 50, 51, 54,
        59, 60, 64, 69, 77,
      ],
      luckyBusinessNumbers: [
        5, 14, 15, 18, 23, 24, 27, 32, 33, 36, 37, 41, 42, 45, 46, 50, 51, 54,
    ...
    '5': {
      ...
      luckyBusinessNumbers: [14, 23, 27, 32, 36, 41, 45, 50, 54, 59, 77],
    },
    '6': {
      description:
      ...
      luckyColors: ['Yellow', 'Blue', 'Red'],
      luckyNameNumbers: [
        14, 15, 23, 24, 27, 32, 33, 36, 41, 42, 50, 54, 60, 77,
      ],
      luckyBusinessNumbers: [
        14, 15, 23, 24, 27, 32, 33, 36, 41, 42, 50, 54, 60, 77,
      ],
    ...
    '8': {
      ...
      luckyNameNumbers: [
        14, 15, 23, 27, 33, 36, 41, 42, 50, 51, 54, 59, 60, 69, 77,
      ],
      luckyBusinessNumbers: [
        14, 15, 23, 27, 33, 36, 41, 42, 50, 51, 54, 59, 60, 69, 77,
      ],
    ...
    '9': {
      ...
      luckyNameNumbers: [
        14, 15, 23, 24, 27, 32, 33, 41, 42, 45, 50, 51, 54, 59, 60, 69, 77,
      ],
      luckyBusinessNumbers: [
        14, 15, 23, 24, 27, 32, 33, 41, 42, 45, 50, 51, 54, 59, 60, 69, 77,
      ],
...
export const numbersRemedy = {
  '1': {
    ...
    missingRemedy: [
      ...
      'They need to place Red Tilak on their forehead.',
      'Can place Copper sun in North east.',
      'Can place a red Swastik in East.',
      'Can do Shiv Pooja.',
      'Can wear Lapiz Lazuli Bracelet for taking the vibes of Number 1.',
    ],
    excessRemedy: [],
  },
  '2': {
    ...
    missingRemedy: [
      ...
      'Can wear Moon Yantra in Silver or white pearl in silver',
      'Can place picture of Dual Mountain in South West',
      'Can keep a white cloth in NW',
      'Can take a silver moon or silver coin from their mother and keep it either with them or in NE direction of their home.',
      'Can give milk to Moon for 40 days.',
      'Wear Rudraksh Crystal Bracelet to activate Number 2',
    ],
    excessRemedy: [],
  },
  '3': {
    ...
    missingRemedy: [
      ...
      'Can plant a banana tree in North east',
      'Need to go Temple on daily i.e., seven days a week',
      'Can place Saffron Tilak on forehead.',
      'Can chant Gayatri Mantra.',
      'Can wear Rudraksh Crystal Bracelet for completing Number 3 in his life or to take its vibes',
    ],
    excessRemedy: [],
  },
  ...
  '4': {
    ...
    missingRemedy: [
      ...
      'South west direction of their home should be balanced.',
      'Can chant Gayatri Mantra',
      'Can give food to street dogs',
      'Wear Rudraksh Crystal Bracelet to activate Number 4',
    ],
    excessRemedy: [],
  },
  '5': {
    ...
    missingRemedy: [
      ...
      'Can place picture of Vishnu Bhagwan in West.',
      'Can cow feed.',
      'Can wear green clothes',
      'Can offer green dal to birds.',
      'Money plant in North',
      'Can wear Green Evanchorine Bracelet, Rudraksh Crystal Bracelet',
    ],
    excessRemedy: [],
  },
  '6': {
    ...
    missingRemedy: [
      ...
      "Place Lakshmi Mata's pic in South east",
      'Keep fragrances with you.',
      'For boys (need to respect ladies)',
      'Girls need to wear Rose Quartz for relationship',
      'Wear Seven Chakras for health.',
      'Fast on Fridays.',
      "Men can wear Cat's Eye Bracelet.",
    ],
    excessRemedy: [],
  },
  '7': {
    ...
    missingRemedy: [
      ...
      'Can place Swastik at the main door.',
      'Donate Food to 3 street dogs',
      'Fast on Thursday',
      "Can place Gautam Budha's picture in NE",
      'Worship Lord Ganesha',
      'Can wear Tiger Eye Bracelet',
    ],
    excessRemedy: [],
  },
  '8': {
    ...
    missingRemedy: [
      ...
      'Keep a Brass Pot of coins in west',
      'Learn from the mistakes, use the experience and make the most of it.',
      'Can Wear Rudraksh Bracelet.',
    ],
    excessRemedy: [],
  },
  '9': {
